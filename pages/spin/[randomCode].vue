<template>
  ...
  >
    ...
    >
      <div
        class="grow w-full flex flex-col items-center justify-center relative mb-4 mt-[10%]"
      >
        <img
        ...
        <div
          ...
          class="grid grid-cols-12 w-full grow pt-[10%]"
        >
          <div class="col-start-2 col-span-10 flex flex-col items-center justify-center gap-3 relative">
            <img
              :src="eventTitle"
              alt="event-title"
              class="w-full h-auto max-h-[15%] object-contain"
            />
            <img
              :src="settings?.global?.gacha_machine_image"
              alt="gacha2"
              class="w-full h-auto max-h-[50%] object-contain"
              preload
            />
            <img
              :src="instruction"
